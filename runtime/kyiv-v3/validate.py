...
from suppression_contract import validate_suppression_state
...
def main():
    ...
    suppression_errors=validate_suppression_state(p.get('ballistic_suppression',{}));tests['ballistic_suppression_contract']=not suppression_errors;tests['ballistic_suppression_untested_zero_effect']=p.get('ballistic_suppression',{}).get('registry_status')!='UNTESTED' or p.get('ballistic_suppression',{}).get('effect',{}).get('applied_delta_points')==0
    if suppression_errors:p['process_qf_v3']='FAIL'
